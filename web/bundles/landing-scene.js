...
`,iv="#fbfbfa",sv="#eceae4";function rv(i,e,t){i.fillStyle=iv,i.fillRect(0,0,e,t),i.fillStyle=sv,i.fillRect(0,0,e*.045,t),i.fillStyle="rgba(40,44,52,0.10)",i.fillRect(e-e*.012,0,e*.012,t)}function av(i){let n=document.createElement("canvas");n.width=512,n.height=336;let s=n.getContext("2d");rv(s,512,336);let r=new ln(n);if(r.colorSpace=qe,r.minFilter=xt,i){let a=new Image;a.onload=()=>{s.drawImage(a,512*.535-248.64/2,336/2-248.64/2,248.64,248.64),r.needsUpdate=!0},a.src=i}return r}var Pl=class{constructor(e,t,n,{x:s=0,z:r=0,height:a=9.5,emblemUrl:o=null,sealUrl:l="assets/img/aaup-emblem.png"}={}){this.m=e,this.group=new it,this.group.name="flag";let c=t.get("name")==="low",h=S=>this.m.get(S),d=new le(new ft(.36,.46,.5,c?8:16),h("limestone-honed"));d.position.y=.25;let u=new le(new ft(.15,.2,.3,c?8:14),h("steel-dark"));u.position.y=.62;let f=new le(new ft(.065,.095,a,c?7:12),h("aluminium"));f.position.y=a/2+.6;let m=new le(new Fi(.13,c?6:12,c?5:8),h("aluminium"));m.position.y=a+.68,[d,u,f,m].forEach(S=>{S.castShadow=!0,S.receiveShadow=!0}),this.group.add(d,u,f,m);let _=4.3,g=2.85,p=new $n(_,g,c?22:44,c?14:28);p.translate(_/2,0,0);let C=av(l);this.uniforms={uTime:{value:0},uWind:{value:1},uMap:{value:C},uLightDir:{value:n.sunDirection.clone()},uLightColour:{value:n.sunColour.clone()},uAmbient:{value:new be(.42,.46,.56)}},this.material=new at({uniforms:this.uniforms,vertexShader:tv,fragmentShader:nv,side:Mt,transparent:!1}),this.cloth=new le(p,this.material),this.cloth.position.set(.06,a-g/2+.2,0),this.cloth.castShadow=!1,this.cloth.receiveShadow=!1,this.cloth.name="cloth",this.group.add(this.cloth),o&&new Tr().load(o,S=>{S.colorSpace=qe,this.uniforms.uMap.value=S},void 0,()=>{}),this.group.position.set(s,.05,r)}get object(){return this.group}update(e){this.uniforms.uTime.value=e}setWind(e){this.uniforms.uWind.value=e}dispose(){this.material.dispose(),this.cloth.geometry.dispose(),this.uniforms.uMap.value.dispose()}};var ov=`
  varying vec3 vWorld;
  varying vec3 vNormalW;
  varying vec2 vUv;
